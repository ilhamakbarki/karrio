"""Karrio Aymakan rating API implementation."""

# import karrio.schemas.aymakan.rating_request as aymakan
# import karrio.schemas.aymakan.rating_response as rating
...
def rate_request(
    ...
    # map data to convert karrio model to aymakan specific type
    request = None
